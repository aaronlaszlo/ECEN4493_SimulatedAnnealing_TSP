...
class SimAnneal(object):
    def __init__(self, coords, temp=-1, alpha=-1, stopping_temp=-1, stopping_iter=-1):
        ...
        self.temp_save = self.temp  # inital temperature to reset if batch annealing is used
        self.alpha = 0.995 if alpha == -1 else alpha
        self.stopping_temperature = 1e-8 if stopping_temp == -1 else stopping_temp
    ...
    def initial_solution(self):
        """
        Greedy algorithm to get initial solution (closest-neighbour).
        """
